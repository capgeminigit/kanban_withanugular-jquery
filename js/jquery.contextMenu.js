(function($) {
 ...
 $.fn.contextmenu = function(option) {
        ...
        itemTpl = "<div class='b-m-$[type]' unselectable=on><nobr unselectable=on><img src='$[icon]' align='absmiddle' width='16' height='16'/><span unselectable=on style='cursor: pointer'>$[text]</span></nobr></div>";
        ...
        var addItems = function(gidx, items) {
            ...
            for (var i = 0; i < items.length; i++) {
                if (items[i].type == "splitLine") {
                    ...
                    $(tmp).bind("click", returnfalse).hover(overItem, outItem);
                } 
